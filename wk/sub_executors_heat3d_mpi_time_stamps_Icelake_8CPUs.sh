...
mpiexec -machinefile $PJM_O_NODEINF -np $PJM_MPI_PROC --bind-to none \
    ../build/mini-apps/heat3d-mpi/executors/heat3d-mpi-executors --px 1 --py 1 --pz 8 --nx 1536 --ny 1536 --nz 192 --nbiter 100 --freq_diag 0 --use_time_stamps 1
mpiexec -machinefile $PJM_O_NODEINF -np $PJM_MPI_PROC --bind-to none \
    ../build/mini-apps/heat3d-mpi/executors/heat3d-mpi-executors --px 1 --py 1 --pz 8 --nx 1536 --ny 1536 --nz 192 --nbiter 100 --freq_diag 0 --use_time_stamps 1 --is_async 1
