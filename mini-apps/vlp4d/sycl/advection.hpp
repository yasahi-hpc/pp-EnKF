...
static inline void lag_basis(const double px, double * coef) {
  ...
  void advect_1D_x(sycl::queue& q, const Config& conf, const RealView4D& fn, RealView4D& fnp1, float64 dt);
  void advect_1D_y(sycl::queue& q, const Config& conf, const RealView4D& fn, RealView4D& fnp1, float64 dt);
  void advect_1D_vx(sycl::queue& q, const Config& conf, const RealView4D& fn, RealView4D& fnp1, std::unique_ptr<Efield>& ef, float64 dt);
  void advect_1D_vy(sycl::queue& q, const Config& conf, const RealView4D& fn, RealView4D& fnp1, std::unique_ptr<Efield>& ef, float64 dt);
  ...
  void advect_1D_x(sycl::queue& q, const Config& conf, const RealView4D& fn, RealView4D& fnp1, float64 dt) {
    ...
    Impl::for_each(q, policy3d, advect_1D_x_functor(conf, _fn, _fnp1, dt));
  };
  ...
  void advect_1D_y(sycl::queue& q, const Config& conf, const RealView4D& fn, RealView4D& fnp1, float64 dt) {
    ...
    Iterate_policy<3> policy3d({0, 0, 0}, {s_nxmax,s_nymax,s_nvxmax});
    Impl::for_each(q, policy3d, advect_1D_y_functor(conf, _fn, _fnp1, dt));
  };
  ...
  void advect_1D_vx(sycl::queue& q, const Config& conf, const RealView4D& fn, RealView4D& fnp1, std::unique_ptr<Efield>& ef, float64 dt) {
    ...
    Iterate_policy<3> policy3d({0, 0, 0}, {s_nxmax,s_nymax,s_nvxmax});
    Impl::for_each(q, policy3d, advect_1D_vx_functor(conf, _fn, _fnp1, ex, dt));
  };
  ...
  void advect_1D_vy(sycl::queue& q, const Config& conf, const RealView4D& fn, RealView4D& fnp1, std::unique_ptr<Efield>& ef, float64 dt) {
    ...
    Iterate_policy<3> policy3d({0, 0, 0}, {s_nxmax,s_nymax,s_nvxmax});
    Impl::for_each(q, policy3d, advect_1D_vy_functor(conf, _fn, _fnp1, ey, dt));
  };
